 ...
 */
package com.magdsoft.watany.adapter;
 ...
 */
public class CustomHintAdapter<T> extends ArrayAdapter<T> {
    private static final String TAG = CustomHintAdapter.class.getSimpleName();
    ...
    public CustomHintAdapter(Context context, int hintResource, List<T> data) {
        this(context, DEFAULT_LAYOUT_RESOURCE, context.getString(hintResource), data);
    }

    public CustomHintAdapter(Context context, String hint, List<T> data) {
        this(context, DEFAULT_LAYOUT_RESOURCE, hint, data);
    }

    public CustomHintAdapter(Context context, int layoutResource, int hintResource, List<T> data) {
        this(context, layoutResource, context.getString(hintResource), data);
    }

    public CustomHintAdapter(Context context, int layoutResource, String hintResource, List<T> data) {
